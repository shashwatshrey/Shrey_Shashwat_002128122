...
public class ViewSupplierJPanel extends javax.swing.JPanel {
    ...
    public ViewSupplierJPanel(JPanel upc, Area a) {
        initComponents();
        userProcessContainer = upc;
        area = a;
        lblSupplierName.setText(a.getAreaName());
        refreshTable();
    }
    ...
    private void initComponents() {
        ...
        productCatalog.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "LicensePlate", "Category", "Model", "Make Year", "Manufacturer", "Seats", "Certificate Exp."
            }
        ) {
