...
public class ViewCarDetailsJPanel extends javax.swing.JPanel {
    ...
    public ViewCarDetailsJPanel(JPanel upc, CarDetails p) {
        initComponents();
        userProcessContainer = upc;
        cardetails = p;
        txtName.setText(p.getcarName());
        txtId.setText(String.valueOf(p.getModelNumber()));
        txtCategory.setText(String.valueOf(p.getCategory()));
    }
    ...
    private void initComponents() {
        ...
        lblProductName.setText("Vehichle Name:");

        txtName.setEditable(false);

        lblProductPrice.setText("Category:");
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        cardetails.setCategory(txtCategory.getText());
        cardetails.setcarName(txtName.getText());
